...
export default function App() {
  ...
  const generateSummaryText = (): string => {
    ...
    // Add credit line
    summary += '\n---\nGenerated by Pay How Much Ah, a web app by Manish Nair. Use it at pay-how-much-ah.vercel.app';
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Pay How Much Ah?</h1>
          <p className="text-gray-600">Split the cost easily</p>
        </div>
